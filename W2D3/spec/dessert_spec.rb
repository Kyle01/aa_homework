...
describe Dessert do
  ...
  let(:chef) { double("chef", name: "Kyle") }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["eggs, chocolate, nuts, milk"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Kyle the Great Baker")
      expect(brownie.serve).to eq("Chef Kyle the Great Baker has made 100 brownies!")
    end
  end
